...
def geoserver_trouble_announcement(enable):
    ...
    if created:
        ann.content = 'Displaying maps, editing MapStories and uploading StoryLayers may not work properly, but should resume shortly. If this problem persists please let the administrators know.'
